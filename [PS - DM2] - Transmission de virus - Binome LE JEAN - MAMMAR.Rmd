...
repeat
{
	...
	if(i>N) # on a parcourue tout les sommets avec le parcours en lageur, donc le graphe est connexe
		{break}
	}
...
simulation_3(N = 10, p = 1)
```


```{r}
generateur_erdos_renyi(N = 10, p = 0.5)
```

```{r}

simulation_3(N = 100, p = 0.01)
